...
export default class Screen1 extends Component {
          ...
          <View
            ...
            <View style={styles.eventTypesContainer}>
              <FlatList
                ...
                renderItem={({item, index}) =>
                  this.renderEventTypeItem(item, index)
                }
              />
            </View>
            <View style={{width: '100%', height: 300}}>
              <FlatList
                ...
                renderItem={({item, index}) =>
                  this.renderUpcomingEventItem(item, index)
                }
              />
            </View>
  ...
  getDummyStories = () => {
    ...
    story[
      KeyConstants.KEY_IMAGE_URL
    ] = require('../../assets/images/lemon.jpg');
    stories.push(story);
    ...
    story[
      KeyConstants.KEY_IMAGE_URL
    ] = require('../../assets/images/pineapple.jpg');
    stories.push(story);
  ...
  getDummyAllEvents = () => {
    ...
    event[KeyConstants.KEY_TITLE] = 'Gala Music Night by DJ Adams in New York';
    event[
      KeyConstants.KEY_IMAGE_URL
    ...
    event[
      KeyConstants.KEY_IMAGE_URL
    ] = require('../../assets/images/event_4.png');
        ...
        <View style={[styles.storyContainer, {marginRight: marginRight}]}>
          ...
          {index == 1 ? (
            <View
              style={[
                styles.liveButton,
                {position: 'absolute', left: 45 / 2 - 11, top: 54 - 15},
              ]}>
              <Image
  ...
  renderEventTypeItem = (item, index) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() =>
          this.setState({selectedEventType: item[KeyConstants.KEY_TITLE]})
        }>
        <LinearGradient
  ...
  renderUpcomingEventItem = (item, index) => {
    ...
    return (
      <TouchableOpacity
        ...
        <View
          style={[styles.upcomingEventContainer, {marginRight: marginRight}]}>
          <Image
          ...
          <View style={styles.eventInfoContainer}>
            ...
            <View style={styles.goingInfoContainer}>
              ...
              <Text style={styles.numberOfGoingText}>
                {item[KeyConstants.KEY_GOING] + '+ '}
              </Text>
      ...
      <TouchableOpacity
        ...
        <View style={styles.eventShortInfoContainer}>
          <Image
            ...
            resizeMode={'cover'}
          />
          <View style={styles.allEventInfoContainer}>
            <Text style={styles.eventDateText}>
              {item[KeyConstants.KEY_DATE]}
            </Text>
            <Text style={styles.eventTitleText} numberOfLines={2}>
